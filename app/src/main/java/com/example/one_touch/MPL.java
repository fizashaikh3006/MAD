...
public class MPL extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        downloadFile(MPL.this,"MPL_writeups",".pdf",DOWNLOAD_SERVICE,url);
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(MPL.this, "Downloading Failed ", LENGTH_SHORT).show();
    ...
    public void Programs(View view) {
        Intent intent = new Intent(MPL.this, MPLProgramms.class);
        startActivity(intent);
    }


    public void view(View view) {
        Intent intent = new Intent(MPL.this, MPLsyllabi.class);
        startActivity(intent);
    }
