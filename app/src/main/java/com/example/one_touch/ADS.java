...
public class ADS extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        downloadFile(ADS.this,"ADS_writeups",".pdf",DOWNLOAD_SERVICE,url);
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ADS.this, "Downloading Failed ", LENGTH_SHORT).show();
    ...
    public void Programs(View view) {
        Intent intent = new Intent(ADS.this, ADSProgramms.class);
        startActivity(intent);
    }


    public void view(View view) {
        Intent intent = new Intent(ADS.this, ADSsyllabi.class);
        startActivity(intent);
    }
   ...
   /* public void links(View view) {
        Intent intent = new Intent(MPL.this, MPLLinks.class);
        startActivity(intent);
